     ...
     <section className="bg-black text-white py-24">
       <div className="container mx-auto px-6">
         <div className="flex items-end justify-between mb-10">
           <h2 className="text-[clamp(1.5rem,3vw,3rem)] font-light uppercase tracking-tighter">Sale</h2>
           <AnimatedButton variant="text">Shop Deals</AnimatedButton>
         </div>
